...
const ALIASES = {
  ...
  "signer-icp": "@ledgerhq/device-signer-kit-icp",
  "signer-utils": "@ledgerhq/signer-utils",
  "signer-tron": "@ledgerhq/device-signer-kit-tron",
...
const DISPLAY_NAMES = {
  ...
  "@ledgerhq/device-signer-kit-hedera": "Signer Hedera",
  "@ledgerhq/device-signer-kit-polkadot": "Signer Polkadot",
  "@ledgerhq/device-signer-kit-zcash": "Signer Zcash",
  "@ledgerhq/device-signer-kit-icp": "Signer ICP",
  "@ledgerhq/device-signer-kit-tron": "Signer TRON",
  "@ledgerhq/device-signer-kit-xrp": "Signer Xrp",
